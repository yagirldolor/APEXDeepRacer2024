...
class ViewManager:
    ...
    def redraw(self, current_track: Track, track_graphics, analyzer, background_analyser,
        ...
        for do in self.drawing_order:
            ...
            if do == "T":
                ...
                if self.waypoints_on:
                    current_track.draw_waypoints(track_graphics, self.track_colour, self.waypoint_minor_size,
