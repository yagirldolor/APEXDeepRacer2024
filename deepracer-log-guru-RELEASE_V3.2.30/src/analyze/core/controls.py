...
class EpisodeRadioButtonControl(Control):
    ...
    def _add_widgets(self):
        ...
        if self.include_evaluations:
            self.add_radiobutton_wide("Evaluations", self._show_what,
                                      EpisodeRadioButtonControl._Values.SHOW_EVALUATIONS.value)
...
class EpisodeRewardTypeControl(Control):
    ...
    def _add_widgets(self):
        ...
        elif self._reward_type.get() in [EpisodeRewardTypeControl._NEW_REWARD_PLUS_TOTAL,
                                         EpisodeRewardTypeControl._NEW_REWARD_PLUS_FUTURE]:
