...
class ActionSpaceFilter:
    ...
    def set_filter_high_speed(self):
        self._action_on = self._action_space.get_new_boolean_marker_that_matches(
            self._action_space.is_high_speed_action)

    def set_filter_medium_speed(self):
        self._action_on = self._action_space.get_new_boolean_marker_that_matches(
            self._action_space.is_medium_speed_action)
