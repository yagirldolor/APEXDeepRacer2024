...
class Episode:
    ...
    def __init__(self, episode_id, iteration, events, object_locations, action_space: ActionSpace,
        ...
        if do_full_analysis:
            (self._blocked_left_waypoints, self._blocked_right_waypoints,
             self._blocked_left_object_locations, self._blocked_right_object_locations) = self.get_blocked_waypoints(
                track)
    ...
    def apply_event_stat_to_heat_map(self, stat_extractor: callable, heat_map: HeatMap, skip_start, skip_end,
                                     action_space_filter: ActionSpaceFilter, waypoint_range):
    ...
    def _apply_episode_to_heat_map(self, heat_map: HeatMap, skip_start, skip_end,
                                   action_space_filter: ActionSpaceFilter, waypoint_range, stat_extractor: callable,
