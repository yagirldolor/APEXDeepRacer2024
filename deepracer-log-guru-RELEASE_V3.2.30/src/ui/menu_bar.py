...
class MenuBar():
    ...
    def add_analyze_menu(self):
        ...
        if not self._is_continuous_action_space:
            menu.add_command(label="Episode Action Distribution",
                             command=self.main_app.menu_callback_analyze_episode_action_distribution)

        menu.add_separator()
        menu.add_command(label="Heatmap", command=self.main_app.menu_callback_analyze_track_heatmap)
        menu.add_command(label="Heatmap + Episode Route",
                         command=self.main_app.menu_callback_analyze_route_over_heatmap)
        menu.add_command(label="Heatmap + Exit Points",
                         command=self.main_app.menu_callback_analyze_exit_points_over_heatmap)
        ...
        menu.add_command(label="Complete Lap Percentage",
                         command=self.main_app.menu_callback_analyze_complete_lap_percentage)

        menu.add_separator()
        menu.add_command(label="Lap Time Correlations",
                         command=self.main_app.menu_callback_analyze_lap_time_correlations)
        menu.add_command(label="Lap Time Distribution",
                         command=self.main_app.menu_callback_analyze_lap_time_distribution)

        menu.add_separator()
        menu.add_command(label="Sector Time Correlations",
                         command=self.main_app.menu_callback_analyze_sector_time_correlations)
    ...
    def add_episode_menu(self):
        ...
        menu.add_command(label="Complete Laps from Start",
                         command=self.main_app.menu_callback_episodes_complete_laps_from_start)
