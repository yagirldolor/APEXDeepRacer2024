...
class EpisodeFilterDialog(Dialog):
    def __init__(self, parent):
        ...
        self.filter_specific_waypoint_min_reward = make_nullable_var(
            self.episode_filter.filter_specific_waypoint_min_reward)
        self.filter_specific_waypoint_min_future_reward = make_nullable_var(
            self.episode_filter.filter_specific_waypoint_min_future_reward)
        self.filter_specific_waypoint_min_track_speed = make_nullable_var(
            self.episode_filter.filter_specific_waypoint_min_track_speed)
        self.filter_specific_waypoint_max_track_speed = make_nullable_var(
            self.episode_filter.filter_specific_waypoint_max_track_speed)
    ...
    def body(self, master):
        ...
        Entry(
            ...
            validate="key", validatecommand=self.validate_section_start_waypoint_id).grid(column=1, row=1, pady=5,
                                                                                          padx=5)
        ...
        Entry(
            ...
            validate="key", validatecommand=self.validate_section_finish_waypoint_id).grid(column=1, row=2, pady=5,
                                                                                           padx=5)
    ...
    def apply(self):
        ...
        self.episode_filter.set_filter_quarters(self.filter_q1.get(), self.filter_q2.get(), self.filter_q3.get(),
                                                self.filter_q4.get())
    ...
    def _validate_modified_section_start(self, value):
        ...
        if is_good:
            self._filter_sector.set(
                self._deduce_name_of_filter_sector(value, self.filter_complete_section_finish.get()))
        return is_good
